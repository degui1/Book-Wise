  ...
  return (
    <>
      <div className="flex flex-col items-center">
        ...
        <div className="bg-muted mt-5 h-[1rem] w-[192px] animate-pulse rounded-xl bg-gray-600" />
        <div className="bg-muted mt-2 h-[1rem] w-[192px] animate-pulse rounded-xl bg-gray-600" />
      </div>
      ...
      <section className="grid grid-cols-2 gap-2 sm:flex sm:flex-row sm:justify-between xl:flex-col xl:items-center xl:gap-10">
        <div className="bg-muted h-[44px] w-[192px] animate-pulse rounded-xl bg-gray-600" />
        <div className="bg-muted h-[44px] w-[192px] animate-pulse rounded-xl bg-gray-600" />
        <div className="bg-muted h-[44px] w-[192px] animate-pulse rounded-xl bg-gray-600" />
        <div className="bg-muted h-[44px] w-[192px] animate-pulse rounded-xl bg-gray-600" />
      </section>
